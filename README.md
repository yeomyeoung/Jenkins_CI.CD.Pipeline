...
### 개요
본 프로젝트는 Jenkins를 활용하여 **CI/CD 파이프라인**을 직접 구성하고 검증한 실습입니다.  
...
초기 설정에서는 Jenkins 컨테이너와 호스트 간 마운트 시,  
**전체 워크스페이스**가 공유되어 불필요한 파일이 노출되는 문제가 있었습니다.  

피드백 과정을 통해 **JAR 파일만 호스트에 마운트**하는 방법을 확인하였으며,  
향후에는 필요한 산출물만 마운트하도록 개선할 계획입니다.
